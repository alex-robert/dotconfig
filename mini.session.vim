...
setlocal statusline=%#lualine_a_command#\ COMMAND\ %#lualine_transitional_lualine_a_command_to_lualine_b_command#%#lualine_b_command#\ \ main\ %#lualine_b_diff_added_command#\ +56\ %#lualine_b_diff_modified_command#~111\ %#lualine_b_diff_removed_command#-30\ %#lualine_transitional_lualine_b_diff_removed_command_to_lualine_c_command#%<%#lualine_c_command#%=%#lualine_c_command#\ utf-8\ %#lualine_c_command#\ \ %#lualine_x_filetype_MiniIconsAzure_command#\ 󰢱\ %#lualine_c_command#lua\ %#lualine_transitional_lualine_b_command_to_lualine_c_command#%#lualine_b_command#\ \ 4%%\ %#lualine_transitional_lualine_a_command_to_lualine_b_command#%#lualine_a_command#\ \ 10:20\ 
