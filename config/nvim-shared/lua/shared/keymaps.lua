...
-- Split navigation (C-M + hjkl)
keymap.set("n", "<C-M-h>", "<C-w>h", { desc = "Go to left split" })
keymap.set("n", "<C-M-j>", "<C-w>j", { desc = "Go to bottom split" })
keymap.set("n", "<C-M-k>", "<C-w>k", { desc = "Go to upper split" })
keymap.set("n", "<C-M-l>", "<C-w>l", { desc = "Go to right split" })

-- Split management (C-w prefix)
...
keymap.set("n", "<C-M-q>", ":bprevious<CR>", { desc = "Previous buffer" })
keymap.set("n", "<C-M-d>", ":bnext<CR>", { desc = "Next buffer" })
